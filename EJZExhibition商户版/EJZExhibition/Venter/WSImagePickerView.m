...
- (void)refreshCollectionView {
    ...
    if (self.getPhotosArrs) {
        self.getPhotosArrs(_photosArray);
    }
}
...
- (void)pickPhotos{
    ...
    UIActionSheet *action = [[UIActionSheet alloc] initWithTitle:nil delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:nil otherButtonTitles:@"拍照",@"从相册获取",nil];
