...
- (UIButton *)getButtonPreview{
    ...
    if (!_btnPreview) {
        ...
        _btnPreview.frame = CGRectMake(10, 0, 70, 50);
        [_btnPreview setTitle:@"Preview" forState:UIControlStateNormal];
        [_btnPreview setTitleColor:COLOR_WITH_RGB(202,0,57,1.0f) forState:UIControlStateNormal];
...
- (UIButton *)getButtonSend{
    ...
    if (!_btnSend) {
        ...
        [_btnSend setTitle:@"Select" forState:UIControlStateNormal];
        [_btnSend setTitleColor:COLOR_WITH_RGB(202,0,57,1.0f) forState:UIControlStateNormal];
...
- (UILabel *)getLabelNumber{
    ...
    if (!_lblNumOfSelect) {
        ...
        _lblNumOfSelect = [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth -85, 16, 18, 18)];
        _lblNumOfSelect.backgroundColor = COLOR_WITH_RGB(202,0,57,1.0f);
...
- (UIButton *)getButtonOriginalImage{
    ...
    if (!_btnOriginal) {
        ...
        _btnOriginal.frame = CGRectMake(25, 10, 70, 30);
        [_btnOriginal setTitle:@"Original" forState:UIControlStateNormal];
        [_btnOriginal setTitleColor:COLOR_WITH_RGB(202,0,57,1.0f) forState:UIControlStateNormal];
