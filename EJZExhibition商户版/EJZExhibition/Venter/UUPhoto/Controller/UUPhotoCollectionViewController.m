...
- (void)configNavigationItem{
    ...
    self.navigationController.navigationBar.tintColor   = COLOR_WITH_RGB(202,0,57,1.0f);
    self.navigationController.navigationBar.barStyle    = UIBarStyleDefault;
    
    
    self.navigationItem.title = @"Album";
    UIBarButtonItem *barCancel = [[UIBarButtonItem alloc] initWithTitle:@"Cancel"
...
- (BOOL)isCheckMaxSelectedFromPhotoBrowser:(UUPhotoBrowserViewController *)browser{
    ...
    if ([UUAssetManager sharedInstance].selectdPhotos.count >= max) {
        ...
        UIAlertView *alter = [[UIAlertView alloc] initWithTitle:[NSString stringWithFormat:@"you may choose most %d photos",(int)max]
                                                        message:nil
                                                       delegate:nil
